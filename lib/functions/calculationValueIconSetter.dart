Map<String, String> setCalculationCurrencyDisp(String symbol) {
...
Map<String, String> setCalculationMineDisp(String symbol) {
  String cur1 = "";
  String cur2 = "";
  String icon1 = "";
  String icon2 = "";
...
Map<String, String> setCalculationSarrDisp(String symbol) {
  String cur1 = "";
...
Map<String, String> setCalculationGramDisp(String symbol) {
  String cur2 = "";
  String icon2 = "";
  String icon1 = "assets/images/currency_and_mine_icons/XAU.png";
  String cur1 = "";
