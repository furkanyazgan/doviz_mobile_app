...
class SarrafiyeSection extends StatefulWidget {
  const SarrafiyeSection({Key? key}) : super(key: key);

  @override
  _SarrafiyeSectionState createState() => _SarrafiyeSectionState();
}

class _SarrafiyeSectionState extends State<SarrafiyeSection> {
  int selectIndex = 0;
  ...
  void changeData() {
    ...
    switch (selectIndex) {
      case 0:
        {
          nowData = context.read<PricesCubit>().state.nowState.sarrData;
          oldData = context.read<PricesCubit>().state.oldState.sarrData;
          dispNameIconSetterFunctionSelect = setSarrDisp;
          virgulSonrasiBasamak = 3;
        }
        break;
      case 1:
        {
          nowData = context.read<PricesCubit>().state.nowState.gramData;
          oldData = context.read<PricesCubit>().state.oldState.gramData;
          dispNameIconSetterFunctionSelect = setGramDisp;
          virgulSonrasiBasamak = 3;
        }
        break;
    }
                    ...
                    Row(
                      children: [
                        ClipRRect(
                            ...
                            child: Image.asset(
                              themeProjectColors.sarrafiyeLogoPath as String,
                              height: 56,
                              width: 56,
                            )),
                        SizedBox(
...
// context.read<PricesCubit>().emit(state);
                    ...
                    Text(
                      strList[selectIndex],
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: themeProjectColors.titleDataTextColor,),
                    ),
                    SizedBox(
                      height: 8,
                    ),
                        ...
                        child: Row(children: [
                          Expanded(
                              ...
                              child: Padding(
                                ...
                                child: Text("Sembol",style: TextStyle(color:themeProjectColors.titleTextColor),),
                              )),
                          Expanded(
                              flex: 3,
                              child: Padding(
                                ...
                                child: Align(
                                  child: Text("Alış",style: TextStyle(color:themeProjectColors.titleTextColor)),
                          ...
                          Expanded(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(right: 17),
                                child: Align(
                                  child: Text("Satış",style: TextStyle(color:themeProjectColors.titleTextColor)),
                                  alignment: AlignmentDirectional.centerEnd,
                                ),
                              )),
                          // ÜST BAR ----------------------------------
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Text(tempData["cur1"]
                                                            .toString() +
                                                        tempData["cur2"]
                                                            .toString(),style: TextStyle(color:themeProjectColors.titleDataTextColor))
                                                  ],
                                                ),
                                              ),
                                            )),
